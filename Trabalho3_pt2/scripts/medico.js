function get() {
    ...
    function myfunction(arr) {
        ...
        for (let i = 0; i < arr.length; i++) {
            out += '<tr class = "table"><td>' + arr[i]['id'] + '</td>' + '<td>' + arr[i]['nome'] + '</td>' + '<td>' + arr[i]['especialidade'] + '</td>' + 
            '<button onclick="alertaa(\'' + id + '\')">Excluir</button>' + '<a href="cadastrar_medico.html?id=' + id + '">Editar</a></td>' + '</tr>'
            }
